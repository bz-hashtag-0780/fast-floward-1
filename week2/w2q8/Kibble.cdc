...
pub contract Kibble: FungibleToken {
    ...
    pub resource Minter {
        ...
        pub fun mintTokens(amount: UFix64): @Kibble.Vault {
            ...
            pre {
                amount > 0.0:  
                    "Why would you mint anything less than zero? Something is wrong"
            }
    ...
    init() {
        ...
        // bz add: Create burner resource and deposit it into the contract account.
